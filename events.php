...
<body>
    ...
    <main>
        ...
        <div id="wrapper">
            ...
            <ul id="detailsList">
                <li><strong><span class="titles">Long Course SWIM - 1.2mi:</span></strong> Participants will make two counter-clockwise loops. Large
                    buoys will mark
                ...
                <li><strong><span class="titles">Long Course BIKE - 58 Miles:</span></strong> A scenic point-to-point course that travels over
                ...
                <li><strong><span class="titles">Long Course RUN - 13.1mi:</span></strong> A mostly flat loop course on widely paved bike paths that
                    traverse
                    through and around this beautiful and scenic destination resort (two hills total with a minimal
                    elevation gain).</li>
                <li><strong><span class="titles">OLYMPIC SWIM - 1,500 meters:</span></strong> Participants will make two counter-clockwise loops.
                    Large buoys will
                ...
                <li><strong><span class="titles">OLYMPIC BIKE - 28mi:</span></strong> A scenic point-to-point course that travels over gently
                    rolling hills. The
                    bike course will be marked with large directional signage and course marshals will be present at key
                    intersections.</li>
                <li><strong><span class="titles">OLYMPIC RUN - 10K:</span></strong> A mostly flat loop course on widely paved bike paths that
                    traverse through and
                    around this beautiful and scenic destination resort (one hill total with a minimal elevation gain).
                </li>
                <li><strong><span class="titles">Sprint:</span></strong> Course will offer a 1-loop 1/2 mile swim, the exact same 28 mile Bike
                    Course as the Olympic
                    distance and a 5km run.</li>
                <li><strong><span class="titles">Try-A-Tri:</span></strong> This novice race is designed for the first time triathlete, those new to
                ...
                <li><strong><span class="titles">Half Marathon COURSE:</span></strong> Half-Marathon (13.1-miles): Half-Marathon event starts and
                ...
                <li><strong><span class="titles">10k COURSE:</span></strong> The 10K event starts and finishes in the Athletes Village. The paths
                ...
                <li><strong><span class="titles">Splash n' Dash:</span></strong> Kids event for participants ages 4 to 15. This is a 100 yard swim
            ...
            <p>Watch the weather closely. The show goes on no matter what the weather is doing. 
                <br><br>You must wear your chip timing piece during the entire event. You will be given a band that will hold your chip timing
                ...
                <br><br><strong><span class="titles">Swim:</span></strong> Wetsuits are optional for the swim but will provide buoyancy and warmth. However, many people opt for no
                wetsuit for a triathlon so no worries. We will provide you with a swim cap but you will want to bring
                your own goggles. <br><br>
                <strong><span class="titles">Bike:</span></strong> A biking helmet is mandatory. You will also receive 2
                ...
                safety reasons, be sure to have end-caps on the end of your handle-bars. 
                <br><br><strong><span class="titles">Run:</span></strong> You must finish the race with your bib number on the front of you. Some people choose to pin it on at
                ...
                <br><br>Remember to bring a change of
